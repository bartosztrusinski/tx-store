...
import { usePersistedReducer } from '@/features/cart/use-persisted-reducer';
...
export function CartProvider({ children }: { children: ReactNode }) {
  const [cart, dispatch] = usePersistedReducer(CART_STORAGE_KEY, cartReducer, INITIAL_CART);
